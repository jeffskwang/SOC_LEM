...
#simulation name
runname = 'example_willis'
#initial DEM file
ini_file = input_folder +'\\willis_DEM.txt'
#observed SOCI file
real_data_file = [input_folder +'\\willis_SOCI.txt']
#ndvi data file
ndvi_data_file = [input_folder +'\\willis_NDVI.txt']

###physical parameters###
D = 0.1875 #[m^2/yr] diffusion coefficient
...
B_SOCI_slope = 92.71 
B_SOCI_int = 6.44 - A_SOCI
C_SOCI_slope = -192.29
C_SOCI_int = 1.896 

B_err = 0.0#multiple of B_error to add to B_SOCI vs. curvature regression
B_n = 11.#number of B_SOCI observations
B_average = -0.001135242901464830#average B_SOCI value
B_MSE = 0.14818495789141978 #mean square error of B_SOCI
B_sum_resid = 0.00013589583637069034#sum of residuals of B_SOCI

#C_SOCI statistics
C_err = 0.0#multiple of B_error to add to B_SOCI vs. curvature regression
C_n = 29.#number of B_SOCI observations
C_average = -0.0013086024861925212#average B_SOCI value
C_MSE = 0.593443745455371#mean square error of B_SOCI
C_sum_resid = 0.0006057960850312982#sum of residuals of B_SOCI
